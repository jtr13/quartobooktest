This is the [Quarto book](https://quarto.org/docs/books/) template for the EDAV final project.
...
- [ ] 1. Click the green "Use this template" button above and choose "Create a new repository". DO NOT FORK THE REPO. Choose a descriptive name for your repo, such as "federalbudget" or "AIDSdeaths". (If you change your topic before you do any work, delete the repo and start over.)
